<template>
  <div>
    ...
    <h1 style="text-align: center; color: black; padding: 1rem">Nos marques</h1>
...
<script setup>
import { ref } from "vue";
import { addMark, updateMark, deleteMark } from "../services/mark.service";
...
async function submitForm() {
  ...
  if (selectedId.value) {
    try {
      await updateMark(selectedId.value, car);
    ...
    try {
      const addedCar = await addMark(car);
